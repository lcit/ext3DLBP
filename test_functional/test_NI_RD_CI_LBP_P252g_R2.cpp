...
std::cout << "=============================================\n";
std::string test = "NI_RD_CI_LBP_P252g_R2";
{
	...
	double mur = 194;
	int V = 4;
	NI_RD_CI_LBP<P252g,R2> lbp(mur, V);
