...
std::cout << "=============================================\n";
std::string test = "NI_RD_LBP_P42g_R1";
{
	...
	double mur = 44;
	int V = 3;
	NI_RD_LBP<P42g,R1> lbp(mur, V);
	Array1D<int,2> LBPcode = lbp.convert(array);
	Array1D<int,2> truth = {43,40};
