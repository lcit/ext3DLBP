...
std::cout << "=============================================\n";
std::string test = "NI_RD_CI_LBP_P92g_R1";
{
	...
	double mur = 44;
	int V = 3;
	NI_RD_CI_LBP<P92g,R1> lbp(mur, V);
	Array1D<int,3> LBPcode = lbp.convert(array);
	Array1D<int,3> truth = {49,89,1};
