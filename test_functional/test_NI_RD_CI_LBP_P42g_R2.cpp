...
std::cout << "=============================================\n";
std::string test = "NI_RD_CI_LBP_P42g_R2";
{
	...
	double mur = 194;
	int V = 4;
	NI_RD_CI_LBP<P42g,R2> lbp(mur, V);
	Array1D<int,3> LBPcode = lbp.convert(array);
	Array1D<int,3> truth = {23,21,0};
